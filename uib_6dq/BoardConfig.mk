...
include device/fsl/uib_6dq/build_id.mk
include device/fsl/imx6/BoardConfigCommon.mk
include device/fsl-proprietary/gpu-viv/fsl-gpu.mk
# uib_6dq default target for EXT4
BUILD_TARGET_FS ?= ext4
include device/fsl/imx6/imx6_target_fs.mk

ifeq ($(BUILD_TARGET_FS),ubifs)
TARGET_RECOVERY_FSTAB = device/fsl/uib_6dq/fstab_nand.freescale
...
TARGET_BOOTLOADER_BOARD_NAME := UIB
PRODUCT_MODEL := UIB-MX6DQ
...
UBI_ROOT_INI := device/fsl/uib_6dq/ubi/ubinize.ini
...
BOARD_BLUETOOTH_BDROID_BUILDCFG_INCLUDE_DIR := device/fsl/uib_6dq/bluetooth
...
TARGET_BOOTLOADER_CONFIG := 6q:mx6q_uib_android_config 6dl:mx6dl_uib_android_config sabre6q:mx6q_sabresd_android_config

TARGET_KERNEL_DEFCONF := imx6_uib_android_defconfig


BOARD_SEPOLICY_DIRS := \
       device/fsl/uib_6dq/sepolicy
